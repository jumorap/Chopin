...
const Terms = () => {
    ...
    return(
        <div className={"general-terms"}>
            ...
            La política de privacidad hace parte integral de estos T&C. Por lo tanto, al aceptarlos en la forma que
            aquí se establece, Usted está suministrando su consentimiento previo, expreso e informado para obligarse
            bajo los términos de la Política de Privacidad. Siempre que en este texto se haga referencia a los T&C, se
            estará haciendo también referencia a la Política de privacidad.
            <p className={"blank-space"}/>

            Red Board se reserva expresamente el derecho a modificar unilateralmente, total o parcialmente, sin
            previo aviso los T&C. El usuario reconoce y acepta que es su responsabilidad revisar periódicamente los T&C.
            <p className={"blank-space"}/>
            ...
            contenido sobre los profesores en las distintas materias y carreras incluidas en Red Board. Para
            proporcionar contenido, el usuario deberá 1. estar o haber estado matriculado como estudiante en la
            universidad y carrera seleccionada y 2. crear un perfil de usuario afiliado a la institución educativa.
            Red Board podrá, en cualquier momento y en desarrollo del proyecto, incluir nuevas carreras, universidades
            y profesores, así como adicionar otros contenidos y calificaciones relativos a los mismos.
            <p className={"blank-space"}/>

            <h4>Mayoría de Edad:</h4>
            Para utilizar la Página Web, el Usuario deberá ser mayor de edad, de acuerdo con la normativa vigente o
            según sea modificada de tiempo en tiempo. En el evento que un menor de edad haga uso de la Página Web,
            deberá contar con la autorización de sus padres o tutores y encontrarse bajo su supervisión. No obstante,
            los menores de edad no podrán generar perfiles de Usuario en la Página Web y deberán hacerlo a través
            de sus padres o tutores legales. Al aceptar estos T&C, el Usuario declara, representa y garantiza que es
            mayor de edad, con capacidad para obligarse legalmente y celebrar contratos, y que toda la información que
            presenta en el momento de registro a la Página Web es verdadera. Red Board se reserva el derecho a
            solicitar evidencia que pruebe su edad.
            <p className={"blank-space"}/>

            <h4>Perfil de Usuario:</h4>
            El usuario no deberá utilizar el perfil o identificación de usuario que 1. le pertenezca a otra persona
            o con la intención de suplantar a esa persona; 2. haga parte del patrimonio o sea parte de los derechos
            que le corresponden a otra persona, sin haber obtenido la autorización correspondiente, y/o 3. que sea
            ...
            contenidos de su página web, en cualquier momento y sin necesidad de aviso o notificación previa al usuario,
            que a su juicio sean ilegales, ofensivos, indecorosos, discriminatorios, difamatorios o que de cualquier
            otra forma violen la legislación aplicable o los presentes T&C. El usuario será el único responsable por
            cualquier pago de regalía, tarifa, o cualquier otro tipo de contraprestación debida con ocasión de la
            ...
            sublicencias. Bajo esta licencia Red Board y sus licenciatarios podrán hacer uso comercial o no de
            los contenidos, de cualquier forma que consideren apropiado, sin que el usuario tenga a derecho a recibir
            contraprestación o remuneración alguna.
            <p className={"blank-space"}/>
            ...
            contratistas, empleados, licenciantes, o cedentes. Cualquier uso no autorizado de los
            elementos y la información que se encuentra en esta página web, que infrinja los derechos de propiedad y de
            propiedad intelectual de Red Board, sus contratistas, empleados, licenciantes, o cedentes y, en
            general, de cualquier tercero, podrá implicar el inicio de las acciones legales correspondientes por parte
            ...
            distinto a lo que aquí se prevé.
            <p className={"blank-space"}/>

            Está prohibida la creación de páginas web, portales de Internet, plataformas, negocios, documentos
            electrónicos o programas de computador o aplicaciones informáticas de cualquier tipo que contengan
            híper-vínculos o marcas que redirijan al navegante a cualquier parte de la página web o que utilicen los
            contenidos de Red Board, sus contratistas, empleados, licenciantes, o cedentes sin un acuerdo explícito
            previo.
            <p className={"blank-space"}/>

            Se excluye expresamente cualquier tipo de responsabilidad que el usuario le pudiere atribuir a Red Board
            como consecuencia de la infracción de los derechos de otros usuarios o de terceros a sus derechos de
            propiedad y de propiedad intelectual. Red Board no se hace responsable por los asuntos de propiedad
            intelectual derivados de los contenidos provenientes de los usuarios o de terceros y de los contenidos
            provistos por los usuarios o terceros.
            <p className={"blank-space"}/>
            ...
            Red Board no garantiza la disponibilidad, infalibilidad y continuidad del funcionamiento de la página web.
            Se excluye cualquier responsabilidad por los daños y perjuicios de toda naturaleza que puedan originarse
            en este sentido.
            <p className={"blank-space"}/>
            ...
            anterior, las restricciones, obligaciones y riesgos asumidos por el usuario al aceptar los T&C, así como
            las limitaciones de responsabilidad e indemnidades establecidas por Red Board en estos T&C,
            sobrevivirán a la terminación de los mismos.
            <p className={"blank-space"}/>
            ...
            como consecuencia de la terminación de estos T&C y de la eliminación de la página web.
            <p className={"blank-space"}/>
            ...
            <h2 className={"subtitle-terms"} id={"privacy"}>Política de Privacidad</h2>
            En Red Board trabajamos para ofrecerte la mejor experiencia posible. En algunos casos, es necesario
            recolectar información para lograrlo, por lo cual, te informamos que Red Board, como el responsable
            del tratamiento de datos, hace uso de un software automatizado para recolección de los mismos.
            <p className={"blank-space"}/>
            ...
            <p className={"blank-space"}/>
                ...
                <ol className={"list-terms"}>
                    <li>
                        La experiencia de usuario mejore, atendiendo a tus intereses y necesidades.
                    </li>
                    <li>
                        Generar un ranking de búsquedas.
                    </li>
                    <li>
                        Rectificar la afiliación correo electrónico del usuario.
                    </li>
                    <li>
                        Complementar la información y adelantar actividades necesarias para gestionar solicitudes,
                        quejas y reclamos.
                    </li>
                    <li>
                        Realizar procesos de archivo, actualización, protección y custodia de información y bases de datos.
                    </li>
                </ol>
            <p className={"blank-space"}/>

            En algunos casos, la ley puede exigir que se revelen datos personales a organismos públicos u otras partes,
            solo se revelará lo estrictamente necesario para el cumplimiento de dichas obligaciones legales. Sin embargo,
            Red Board nunca venderá sus datos personales a terceros.
            <p className={"blank-space"}/>

            Red Board no es responsable de hipotéticos daños o perjuicios que se pudieran derivar de interferencias,
            omisiones, interrupciones, virus informáticos, averías telefónicas o desconexiones en el funcionamiento
            operativo de este sistema electrónico, motivadas por causas ajenas a Red Board.
            <p className={"blank-space"}/>

            En el sitio web puede haber enlaces a otras páginas web. Al hacer clic en uno de estos
            enlaces y acceder a un sitio web externo, la visita estará sujeta a la política de privacidad de dicho
            sitio web, quedando Red Board desvinculado de cualquier tipo de responsabilidad acerca de su política
            de privacidad.
            <p className={"blank-space"}/>

            Las políticas de privacidad pueden modificarse. Te recomendamos que las revises con cierta periodicidad.


            <h2 className={"subtitle-terms"} id={"cookies"}>Política de Cookies</h2>
            En Red Board podemos usar "cookies" y otras tecnologías de monitoreo para conocer tus interacciones dentro
            del sitio web. Así podemos darte un mejor servicio y mejorar el sitio web.
            <p className={"blank-space"}/>

            Puedes desactivar el uso de cookies en cualquier momento. Puede que esto afecte tu experiencia de uso.
            <p className={"blank-space"}/>

            <ul className={"list-terms"}>
                <li>
                    <a className={"link-terms"} href={"https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&oco=1&hl=es-419"} target={"_blank"} rel="noreferrer">
                        Google Chrome
                    </a>
                </li>
                <li>
                    <a className={"link-terms"} href={"https://support.mozilla.org/es/kb/impedir-que-los-sitios-web-guarden-sus-preferencia"} target={"_blank"} rel="noreferrer">
                        Mozilla Firefox
                    </a>
                </li>
                <li>
                    <a className={"link-terms"} href={"https://support.apple.com/es-lamr/guide/safari/sfri11471/mac"} target={"_blank"} rel="noreferrer">
                        Safari
                    </a>
                </li>
                <li>
                    <a className={"link-terms"} href={"https://support.microsoft.com/es-es/windows/eliminar-y-administrar-cookies-168dab11-0753-043d-7c16-ede5947fc64d"} target={"_blank"} rel="noreferrer">
                        Internet Explorer
                    </a>
                </li>
                <li>
                    <a className={"link-terms"} href={"https://support.microsoft.com/es-es/microsoft-edge/eliminar-las-cookies-en-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09"} target={"_blank"} rel="noreferrer">
                        Microsoft Edge
                    </a>
                </li>
                <li>
                    <a className={"link-terms"} href={"https://help.opera.com/en/latest/web-preferences/#cookies"} target={"_blank"} rel="noreferrer">
                        Opera
                    </a>
                </li>
            </ul>
            ...
            Red Board se reserva expresamente el derecho a modificar unilateralmente, total o parcialmente, sin
            previo aviso, la presente Política de Cookies. El usuario reconoce y acepta que es su
            responsabilidad revisar periódicamente la presente Política de Cookies.
            <p className={"blank-space"}/>
